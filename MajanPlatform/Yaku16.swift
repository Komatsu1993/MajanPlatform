...
class Yaku16 {
    ...
    func chentaiu(m1:[Int], m2:[Int], m3:[Int], m4:[Int], h:Int)->() {
        ...
        var x = 0
        for i in check {
            if i[0] != 4, i[0] != 13, i[0] != 22, i[1] != 4 ,i[1] != 13, i[1] != 22, i[2] != 4, i[2] != 13, i[2] != 22{
                x += 1
            }
        }
    ...
    func santonku(k1:Int, k2:Int, k3:Int, k4:Int, m1:[Int], m2:[Int], m3:[Int], m4:[Int])->() {
        if (k1 >= 1 && k2 >= 1 && k3 >= 1 && m2[0] - m1[0] == 9 && m3[0] - m2[0] == 9 && m3[0] < 27) ||
            (k1 >= 1 && k2 >= 1 && k4 >= 1 && m2[0] - m1[0] == 9 && m4[0] - m2[0] == 9 && m4[0] < 27) ||
            (k1 >= 1 && k3 >= 1 && k4 >= 1 && m3[0] - m1[0] == 9 && m4[0] - m3[0] == 9 && m4[0] < 27) ||
            (k2 >= 1 && k3 >= 1 && k4 >= 1 && m3[0] - m2[0] == 9 && m4[0] - m3[0] == 9 && m4[0] < 27) {
            if yaku[31] != -1 {
                yaku[31] = 1
                yaku[65] = -1
            }
